...
//
    ...
    public static String convertANumberToHexadecimal(int num){
        ...
        //the hexidecimal alphabet in order so we can get correct letter/number based on remainder below
        ...
        while (num > 0){
            //calculate the remainer which will be our character
            remainder = num % 16;
            //if the number is 0 and all that was left was the remainder add character and then break
            if(num == 0){
